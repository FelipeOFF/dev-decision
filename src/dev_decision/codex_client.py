...
from dev_decision.client import (
    ContextUpdate,
    ReviewRequest,
    review_request,
)
from dev_decision.context import ContextResult, discover_skill_catalog
...
class AutomaticSkillRouter:
    ...
    offline_warning = (
        "Dev Decision MCP is unavailable; continuing with Codex skill routing."
    )
